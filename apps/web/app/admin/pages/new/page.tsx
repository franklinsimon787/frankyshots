...
export default function NewPage() {
  ...
  async function handleSubmit(
    ...
    try {
       ...
       * Upload image first.
       */
      let uploadedImageUrl: string | null = image || null;
      ...
      /*
       * STEP 2
       * Create page with the actual image URL.
       */
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-10">
          ...
          <p className="mt-3 text-sm text-gray-500">
            Create and publish a custom page for the Frankyshots website.
          </p>
        ...
        >
          ...
          <div className="mb-7">
            ...
            <input
              ...
              placeholder="About Frankyshots"
              className="w-full border border-white/10 bg-black px-4 py-3 text-sm text-white outline-none transition placeholder:text-gray-700 focus:border-white/30"
            />
          ...
          <div className="mb-7">
            ...
            <div className="flex items-center border border-white/10 bg-black">
              ...
              <input
                ...
                placeholder="about-frankyshots"
                className="w-full bg-transparent px-2 py-3 text-sm text-white outline-none placeholder:text-gray-700"
              />

            </div>

            <p className="mt-2 text-xs text-gray-700">
              This value will be used as the page URL.
            </p>
          ...
          <div className="mb-7">
            ...
            <textarea
              ...
              rows={16}
              className="w-full resize-y border border-white/10 bg-black px-4 py-3 text-sm leading-7 text-white outline-none transition placeholder:text-gray-700 focus:border-white/30"
            />

            <p className="mt-2 text-xs text-gray-700">
              Enter the main content for this page.
            </p>
          ...
          <div className="mb-7">
            ...
            <p className="mt-2 text-xs text-gray-700">
              Select a featured image for this page.
            </p>
