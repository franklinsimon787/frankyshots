  ...
  useEffect(() => {
    async function loadReptiles() {
      try {
        ...
        if (!response.ok) {
          throw new Error("Failed to load reptiles.");
        }

        const data = await response.json();

        const reptileSpecies = data.filter(
          (item: Reptile) =>
            item.category.toLowerCase() === "reptiles"
        );

        setReptiles(reptileSpecies);
      } catch (error) {
      ...
      <section className="relative flex min-h-[65vh] items-end overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-20 md:px-10">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-gray-300 md:text-lg">
            A dedicated archive documenting reptiles and their role within
            the ecosystems of the wild.
          </p>
      ...
      <section className="border-b border-white/10 px-6 py-16 md:px-10">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <p className="max-w-3xl text-xl leading-9 text-gray-300 md:text-2xl">
            Reptiles are an important part of natural ecosystems. This
            collection will document the reptiles encountered during
            field observations and wildlife exploration.
          </p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
            ...
            <p className="max-w-md text-sm leading-7 text-gray-500">
              A growing archive of reptiles documented through field
              ...
              {reptiles.map((reptile, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-7">
                    ...
                    <Link
  href={`/wildlife/category/${reptile.slug}`}
          ...
          {!loading && reptiles.length === 0 && (
            <div className="mt-14 border border-white/10 bg-neutral-950 p-8">
              <p className="text-gray-500">
                No published reptile species available.
              </p>
            </div>
          )}
      ...
      <section className="border-t border-white/10 px-6 py-20 md:px-10">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl leading-8 text-gray-500">
            Species information, photographs, habitat details and field
            observations will be added to the archive.
          </p>
