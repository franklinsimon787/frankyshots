...
export default function Fish() {
  ...
  async function loadFish() {
    try {
      ...
      const fishSpecies = data.filter(
        (item: Fish) =>
          item.category.toLowerCase() === "fish"
      );

      setFish(fishSpecies);
    } catch (error) {
      console.error(error);
      setError("Unable to load fish species.");
    } finally {
      setLoading(false);
    }
  }
      ...
      <section className="relative flex min-h-[65vh] items-end overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-20 md:px-10">
          ...
          <p className="mt-6 max-w-2xl text-base leading-8 text-gray-300 md:text-lg">
            An archive of freshwater fish documented through field
            observation and wildlife exploration.
          </p>
      ...
      <section className="border-b border-white/10 px-6 py-16 md:px-10">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <p className="max-w-3xl text-xl leading-9 text-gray-300 md:text-2xl">
            Aquatic life forms an important part of freshwater ecosystems.
            This collection documents fish species encountered during
            field observations.
          </p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
            ...
            <p className="max-w-md text-sm leading-7 text-gray-500">
              A growing photographic record of freshwater fish documented
          ...
          {/* EMPTY */}
          {!loading && !error && fish.length === 0 && (
            <div className="mt-14 border border-white/10 bg-neutral-950 p-8">

              <p className="text-gray-400">
                No fish species have been added yet.
              </p>

              <p className="mt-2 text-sm text-gray-600">
                Add a species from the Frankyshots Admin Panel and select
                Fish as its category.
              </p>
