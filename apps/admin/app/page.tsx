...
const sections = [
  ...
  {
    title: "Vickverse",
    description: "Manage mythology, mythical and horror content separately.",
  ...
  {
    title: "AI Tools",
    description: "Future AI features such as wildlife image detection and 3D tools.",
    href: "/admin/ai",
    status: "Future",
  },
];
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="mt-4 max-w-2xl text-gray-400">
            ...
            projects, custom pages, Vickverse content and future tools.
          </p>
        </div>
